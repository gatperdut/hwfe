...
import { CampaignService } from '../../campaign-aux/services/campaign.service';
import { Campaign } from '../../campaign-aux/types/campaign.type';
import { CampaignNavService } from '../../campaign/services/campaign-nav.service';
...
import { UserCampaignsDto } from '../../user-aux/dto/user-campaigns.dto';
...
export class UserCampaignsComponent {
  ...
  private campaignNavService = inject(CampaignNavService);

  public campaigns$: Observable<Campaign[]>;

  private refresh$ = new Subject<void>();

  public columns: string[] = ['name', 'master', 'players', 'actions'];
  ...
  public toCampaign(campaign: Campaign): void {
    this.campaignNavService.toManage(campaign.id as number);
  }
}
